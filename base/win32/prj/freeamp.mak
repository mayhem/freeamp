...
"$(INTDIR)\freeamp.res" : $(SOURCE) "$(INTDIR)"
	$(RSC) /l 0x409 /fo"$(INTDIR)\freeamp.res" /i "\Local\src\freeamp-2-0-6\base\win32\res" /d "NDEBUG" $(SOURCE)
...
"$(INTDIR)\freeamp.res" : $(SOURCE) "$(INTDIR)"
	$(RSC) /l 0x409 /fo"$(INTDIR)\freeamp.res" /i "\Local\src\freeamp-2-0-6\base\win32\res" /d "_DEBUG" $(SOURCE)
