...
"$(INTDIR)\http.res" : $(SOURCE) "$(INTDIR)"
	$(RSC) /l 0x409 /fo"$(INTDIR)\http.res" /i "\Local\src\freeamp-2-0-6\io\http\win32\res" /d "NDEBUG" $(SOURCE)
...
"$(INTDIR)\http.res" : $(SOURCE) "$(INTDIR)"
	$(RSC) /l 0x409 /fo"$(INTDIR)\http.res" /i "\Local\src\freeamp-2-0-6\io\http\win32\res" /d "_DEBUG" $(SOURCE)
