...
$(DS_POSTBUILD_DEP) : "..\..\..\..\config\config.h" ".\fileinput.pmi"
...
"$(INTDIR)\local.res" : $(SOURCE) "$(INTDIR)"
	$(RSC) /l 0x409 /fo"$(INTDIR)\local.res" /i "\Local\src\freeamp-2-0-6\io\local\win32\res" /d "NDEBUG" $(SOURCE)
...
"$(INTDIR)\local.res" : $(SOURCE) "$(INTDIR)"
	$(RSC) /l 0x409 /fo"$(INTDIR)\local.res" /i "\Local\src\freeamp-2-0-6\io\local\win32\res" /d "_DEBUG" $(SOURCE)
