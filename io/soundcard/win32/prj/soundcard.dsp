...
# ADD LINK32 kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /subsystem:windows /dll /machine:I386 /out:"soundcard.pmo"
...
SOURCE=$(InputPath)
PostBuild_Cmds=copy soundcard.pmo ..\..\..\..\base\win32\prj\io
