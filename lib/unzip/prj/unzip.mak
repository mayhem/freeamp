...
!MESSAGE No configuration specified. Defaulting to unzip - Win32 NASM Debug.
!ENDIF 
...
CPP_PROJ=/nologo /MD /W3 /GX /O2 /I "..\include" /I "..\..\zlib\include" /I "..\..\..\config" /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /Fp"$(INTDIR)\unzip.pch" /YX /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /c 
BSC32=bscmake.exe
...
CPP_PROJ=/nologo /MDd /W3 /GX /Z7 /Od /I "..\include" /I "..\..\zlib\include" /I "..\..\..\config" /D "WIN32" /D "_DEBUG" /D "_WINDOWS" /Fp"$(INTDIR)\unzip.pch" /YX /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /c 
BSC32=bscmake.exe
BSC32_FLAGS=/nologo /o"$(OUTDIR)\unzip.bsc" 
BSC32_SBRS= \
