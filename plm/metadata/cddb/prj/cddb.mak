...
!IF "$(CFG)" == ""
CFG=cddb - Win32 NASM Debug
!MESSAGE No configuration specified. Defaulting to cddb - Win32 NASM Debug.
!ENDIF 
...
!MESSAGE 
!MESSAGE NMAKE /f "cddb.mak" CFG="cddb - Win32 NASM Debug"
!MESSAGE 
...
CPP_PROJ=/nologo /MD /W3 /GX /O2 /I "..\..\\" /I "..\..\..\include" /I "..\..\include" /I "..\..\..\..\io\include" /I "..\..\..\..\base\include" /I "..\..\..\..\base\win32\include" /I "..\..\..\..\config" /I "..\..\..\..\ui\include" /I "..\..\..\..\lmc\include" /I "..\..\..\..\io\cd\win32\include" /I "..\..\..\..\lib\gdbm" /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /Fp"$(INTDIR)\cddb.pch" /YX /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /c 
...
LINK32=link.exe
LINK32_FLAGS=fabaselib.lib gdbm.lib version.lib wsock32.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /base:"0x10500000" /subsystem:windows /dll /incremental:no /pdb:"$(OUTDIR)\cddb.pdb" /machine:I386 /def:".\cddb.def" /out:"cddb.mdf" /implib:"$(OUTDIR)\cddb.lib" /libpath:"..\..\..\..\base\win32" /libpath:"..\..\..\..\lib\gdbm" 
DEF_FILE= \
	".\cddb.def"
LINK32_OBJS= \
	"$(INTDIR)\cddb.obj" \
...
CPP_PROJ=/nologo /MDd /W3 /Gm /GX /ZI /Od /I "..\..\\" /I "..\..\..\include" /I "..\..\include" /I "..\..\..\..\io\include" /I "..\..\..\..\base\include" /I "..\..\..\..\base\win32\include" /I "..\..\..\..\config" /I "..\..\..\..\ui\include" /I "..\..\..\..\lmc\include" /I "..\..\..\..\io\cd\win32\include" /I "..\..\..\..\lib\gdbm" /D "WIN32" /D "_DEBUG" /D "_WINDOWS" /Fp"$(INTDIR)\cddb.pch" /YX /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /c 
...
LINK32=link.exe
LINK32_FLAGS=fabaselib.lib gdbm.lib version.lib wsock32.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /base:"0x10500000" /subsystem:windows /dll /incremental:yes /pdb:"$(OUTDIR)\cddb.pdb" /debug /machine:I386 /def:".\cddb.def" /out:"cddb.mdf" /implib:"$(OUTDIR)\cddb.lib" /pdbtype:sept /libpath:"..\..\..\..\base\win32" /libpath:"..\..\..\..\lib\gdbm" 
DEF_FILE= \
	".\cddb.def"
LINK32_OBJS= \
	"$(INTDIR)\cddb.obj" \
