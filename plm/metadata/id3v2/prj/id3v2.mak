...
LINK32_FLAGS=fabaselib.lib wsock32.lib kernel32.lib user32.lib gdi32.lib\
 ...
 uuid.lib odbc32.lib odbccp32.lib /nologo /base:"0x10600000" /subsystem:windows\
 /dll /incremental:no /pdb:"$(OUTDIR)\id3v2.pdb" /machine:I386\
 /def:".\id3v2.def" /out:"id3v2.mdf" /implib:"$(OUTDIR)\id3v2.lib"\
 /libpath:"..\..\..\..\base\win32" 
DEF_FILE= \
	".\id3v2.def"
LINK32_OBJS= \
...
LINK32_FLAGS=fabaselib.lib wsock32.lib kernel32.lib user32.lib gdi32.lib\
 winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib\
 uuid.lib odbc32.lib odbccp32.lib /nologo /base:"0x10600000" /subsystem:windows\
 /dll /incremental:yes /pdb:"$(OUTDIR)\id3v2.pdb" /debug /machine:I386\
