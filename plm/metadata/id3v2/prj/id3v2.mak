...
LINK32_FLAGS=wsock32.lib kernel32.lib user32.lib gdi32.lib winspool.lib\
 ...
 /pdb:"$(OUTDIR)\id3v2.pdb" /machine:I386 /def:".\id3v2.def" /out:"id3v2.mdf"\
 /implib:"$(OUTDIR)\id3v2.lib" 
DEF_FILE= \
	".\id3v2.def"
LINK32_OBJS= \
	"$(INTDIR)\id3v2.obj" \
...
LINK32_FLAGS=wsock32.lib kernel32.lib user32.lib gdi32.lib winspool.lib\
 ...
 /pdb:"$(OUTDIR)\id3v2.pdb" /debug /machine:I386 /def:".\id3v2.def"\
 /out:"id3v2.mdf" /implib:"$(OUTDIR)\id3v2.lib" /pdbtype:sept 
DEF_FILE= \
	".\id3v2.def"
LINK32_OBJS= \
	"$(INTDIR)\id3v2.obj" \
...
"$(INTDIR)\id3v2.res" : $(SOURCE) "$(INTDIR)"
 ...
 "\Local\src\freeamp1.5\plm\metadata\id3v2\res" /d "NDEBUG" $(SOURCE)
...
"$(INTDIR)\id3v2.res" : $(SOURCE) "$(INTDIR)"
	$(RSC) /l 0x409 /fo"$(INTDIR)\id3v2.res" /i\
 "\Local\src\freeamp1.5\plm\metadata\id3v2\res" /d "_DEBUG" $(SOURCE)
