...
LINK32_FLAGS=fabaselib.lib kernel32.lib user32.lib gdi32.lib winspool.lib\
 ...
 /pdb:"$(OUTDIR)\pls.pdb" /machine:I386 /def:".\pls.def" /out:"pls.plf"\
 /implib:"$(OUTDIR)\pls.lib" /libpath:"..\..\..\..\base\win32" 
DEF_FILE= \
	".\pls.def"
LINK32_OBJS= \
	"$(INTDIR)\debug.obj" \
...
LINK32_FLAGS=fabaselib.lib kernel32.lib user32.lib gdi32.lib winspool.lib\
 ...
 /pdb:"$(OUTDIR)\pls.pdb" /debug /machine:I386 /def:".\pls.def" /out:"pls.plf"\
 /implib:"$(OUTDIR)\pls.lib" /pdbtype:sept /libpath:"..\..\..\..\base\win32" 
DEF_FILE= \
	".\pls.def"
LINK32_OBJS= \
	"$(INTDIR)\debug.obj" \
