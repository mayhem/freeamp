...
!IF "$(CFG)" != "pmp300 - Win32 Release" && "$(CFG)" != "pmp300 - Win32 Debug" && "$(CFG)" != "pmp300 - Win32 NASM Release" && "$(CFG)" != "pmp300 - Win32 NASM Debug" && "$(CFG)" != "pmp300 - Win32 NASM Debug MS STL"
...
!MESSAGE "pmp300 - Win32 NASM Debug MS STL" (based on "Win32 (x86) Dynamic-Link Library")
!MESSAGE 
...
!ELSEIF  "$(CFG)" == "pmp300 - Win32 NASM Debug MS STL"
...
ALL : "fabaselib - Win32 NASM Debug MS STL" "riolib - Win32 NASM Debug MS STL" ".\pmp300.ppp"

!ENDIF 

!IF "$(RECURSE)" == "1" 
CLEAN :"riolib - Win32 NASM Debug MS STLCLEAN" "fabaselib - Win32 NASM Debug MS STLCLEAN" 
!ELSE 
CLEAN :
!ENDIF 
	-@erase "$(INTDIR)\pmp300.obj"
...
CPP_PROJ=/nologo /MDd /W3 /Gm /GX /ZI /Od /I "..\sba" /I "..\..\\" /I "..\..\..\include" /I "..\..\include" /I "..\..\..\..\io\include" /I "..\..\..\..\base\include" /I "..\..\..\..\base\win32\include" /I "..\..\..\..\config" /I "..\..\..\..\ui\include" /I "..\..\..\..\lmc\include" /D "_DEBUG" /D "_WINDOWS" /D "WIN32" /Fp"$(INTDIR)\pmp300.pch" /YX /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /c 
MTL_PROJ=/nologo /D "_DEBUG" /mktyplib203 /o "NUL" /win32 
RSC_PROJ=/l 0x409 /fo"$(INTDIR)\pmp300.res" /d "_DEBUG" 
BSC32=bscmake.exe
BSC32_FLAGS=/nologo /o"$(OUTDIR)\pmp300.bsc" 
...
$(DS_POSTBUILD_DEP) : "fabaselib - Win32 NASM Debug MS STL" "riolib - Win32 NASM Debug MS STL" ".\pmp300.ppp"
   IF NOT EXIST ..\..\..\..\base\win32\prj\plugins mkdir                                 ..\..\..\..\base\win32\prj\plugins
	copy pmp300.ppp        ..\..\..\..\base\win32\prj\plugins
	echo Helper for Post-build step > "$(DS_POSTBUILD_DEP)"
...
"riolib - Win32 NASM Debug MS STL" : 
   cd "\Local\src\freeamp\plm\portable\pmp300\sba\prj"
   $(MAKE) /$(MAKEFLAGS) /F .\riolib.mak CFG="riolib - Win32 NASM Debug MS STL" 
   cd "..\..\prj"

"riolib - Win32 NASM Debug MS STLCLEAN" : 
   cd "\Local\src\freeamp\plm\portable\pmp300\sba\prj"
   $(MAKE) /$(MAKEFLAGS) /F .\riolib.mak CFG="riolib - Win32 NASM Debug MS STL" RECURSE=1 CLEAN 
   cd "..\..\prj"
