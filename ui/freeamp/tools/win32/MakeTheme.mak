...
!MESSAGE No configuration specified. Defaulting to MakeTheme - Win32 NASM Debug MS STL.
!ENDIF 

!IF "$(CFG)" != "MakeTheme - Win32 Release" && "$(CFG)" != "MakeTheme - Win32 Debug" && "$(CFG)" != "MakeTheme - Win32 NASM Debug" && "$(CFG)" != "MakeTheme - Win32 NASM Release" && "$(CFG)" != "MakeTheme - Win32 NASM Debug MS STL"
...
LINK32=link.exe
LINK32_FLAGS=zlib.lib unzip.lib setargv.obj kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /subsystem:console /incremental:no /pdb:"$(OUTDIR)\MakeTheme.pdb" /machine:I386 /out:"MakeTheme.exe" /libpath:"..\..\..\..\lib\zlib" /libpath:"..\..\..\..\lib\unzip" 
LINK32_OBJS= \
...
ALL : "zlib - Win32 NASM Debug" "unzip - Win32 NASM Debug" "..\..\..\..\config\config.h" ".\MakeTheme.exe"
...
$(DS_POSTBUILD_DEP) : "zlib - Win32 NASM Debug" "unzip - Win32 NASM Debug" "..\..\..\..\config\config.h" ".\MakeTheme.exe"
   IF NOT EXIST ..\..\..\..\base\win32\prj\tools mkdir                                                    ..\..\..\..\base\win32\prj\tools
	copy MakeTheme.exe     ..\..\..\..\base\win32\prj\tools
	copy ..\..\howto\ThemeHowTo.txt     ..\..\..\..\base\win32\prj\tools
	echo Helper for Post-build step > "$(DS_POSTBUILD_DEP)"
...
ALL : "zlib - Win32 NASM Debug MS STL" "unzip - Win32 NASM Debug MS STL" "..\..\..\..\config\config.h" ".\MakeTheme.exe"

!ENDIF 

!IF "$(RECURSE)" == "1" 
CLEAN :"unzip - Win32 NASM Debug MS STLCLEAN" "zlib - Win32 NASM Debug MS STLCLEAN" 
!ELSE 
CLEAN :
!ENDIF 
	-@erase "$(INTDIR)\MakeTheme.obj"
...
CPP_PROJ=/nologo /MDd /W3 /Gm /GX /ZI /Od /I "../../include" /I "../../../../lib/zlib/include" /I "../../../../lib/unzip/include" /I "../../../../config" /I "../../../../base/include" /D "_DEBUG" /D "_CONSOLE" /D "_MBCS" /D "WIN32" /Fp"$(INTDIR)\MakeTheme.pch" /YX /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /c 
RSC_PROJ=/l 0x409 /fo"$(INTDIR)\MakeTheme.res" /d "_DEBUG" 
BSC32=bscmake.exe
BSC32_FLAGS=/nologo /o"$(OUTDIR)\MakeTheme.bsc" 
BSC32_SBRS= \
...
$(DS_POSTBUILD_DEP) : "zlib - Win32 NASM Debug MS STL" "unzip - Win32 NASM Debug MS STL" "..\..\..\..\config\config.h" ".\MakeTheme.exe"
   IF NOT EXIST ..\..\..\..\base\win32\prj\tools mkdir                                                    ..\..\..\..\base\win32\prj\tools
	copy MakeTheme.exe     ..\..\..\..\base\win32\prj\tools
	copy ..\..\howto\ThemeHowTo.txt     ..\..\..\..\base\win32\prj\tools
	echo Helper for Post-build step > "$(DS_POSTBUILD_DEP)"
...
"unzip - Win32 NASM Debug MS STL" : 
   cd "\Local\src\freeamp\lib\unzip\prj"
   $(MAKE) /$(MAKEFLAGS) /F .\unzip.mak CFG="unzip - Win32 NASM Debug MS STL" 
   cd "..\..\..\ui\freeamp\tools\win32"

"unzip - Win32 NASM Debug MS STLCLEAN" : 
   cd "\Local\src\freeamp\lib\unzip\prj"
   $(MAKE) /$(MAKEFLAGS) /F .\unzip.mak CFG="unzip - Win32 NASM Debug MS STL" RECURSE=1 CLEAN 
   cd "..\..\..\ui\freeamp\tools\win32"
