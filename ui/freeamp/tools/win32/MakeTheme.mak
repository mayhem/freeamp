...
CPP_PROJ=/nologo /MD /W3 /GX /O2 /I "../../include" /I "../../../../lib/zlib/include" /I "../../../../lib/unzip/include" /I "../../../../config" /I "../../../../base/include" /D "WIN32" /D "NDEBUG" /D "_CONSOLE" /D "_MBCS" /Fp"$(INTDIR)\MakeTheme.pch" /YX /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /c 
...
ALL : "zlib - Win32 Debug" "unzip - Win32 Debug" ".\MakeTheme.exe"
...
CPP_PROJ=/nologo /MDd /W3 /Gm /GX /ZI /Od /I "../../include" /I "../../../../lib/zlib/include" /I "../../../../lib/unzip/include" /I "../../../../config" /I "../../../../base/include" /D "WIN32" /D "_DEBUG" /D "_CONSOLE" /D "_MBCS" /Fp"$(INTDIR)\MakeTheme.pch" /YX /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /c 
...
$(DS_POSTBUILD_DEP) : "zlib - Win32 Debug" "unzip - Win32 Debug" ".\MakeTheme.exe"
   IF NOT EXIST ..\..\..\..\base\win32\prj\tools mkdir                                                    ..\..\..\..\base\win32\prj\tools
	copy MakeTheme.exe     ..\..\..\..\base\win32\prj\tools
	copy ..\..\howto\ThemeHowTo.txt     ..\..\..\..\base\win32\prj\tools
	echo Helper for Post-build step > "$(DS_POSTBUILD_DEP)"
