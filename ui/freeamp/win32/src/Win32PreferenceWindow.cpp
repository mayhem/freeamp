/*____________________________________________________________________________
   ...
   $Id: Win32PreferenceWindow.cpp,v 1.45.4.1 2000/06/05 13:42:56 elrod Exp $
____________________________________________________________________________*/
...
void Win32PreferenceWindow::GetPrefsValues(PrefsStruct* values)
{
	...
	if(kError_BufferTooSmall == m_prefs->GetPlaylistHeaderColumns( buffer, &size ) )
	{
        bufferSize = size;
        buffer = (char*)realloc(buffer, bufferSize);
        m_prefs->GetPlaylistHeaderColumns(buffer, &size);
	}
...
void Win32PreferenceWindow::SavePrefsValues(PrefsStruct* values)
{
	...
	m_prefs->SetPlaylistHeaderColumns((char*)values->playlistHeaderColumns.c_str() );
