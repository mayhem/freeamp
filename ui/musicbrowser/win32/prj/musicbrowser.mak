...
"$(INTDIR)\musicbrowser.res" : $(SOURCE) "$(INTDIR)"
	$(RSC) /l 0x409 /fo"$(INTDIR)\musicbrowser.res" /i "\Local\src\freeamp-2-0-6\ui\musicbrowser\win32\res" /d "NDEBUG" $(SOURCE)
...
"$(INTDIR)\musicbrowser.res" : $(SOURCE) "$(INTDIR)"
	$(RSC) /l 0x409 /fo"$(INTDIR)\musicbrowser.res" /i "\Local\src\freeamp-2-0-6\ui\musicbrowser\win32\res" /d "_DEBUG" $(SOURCE)
