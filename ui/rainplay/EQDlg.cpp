...
#define	LOWER_LIMIT_DB	-12
#define	UPPER_LIMIT_DB	12
#define	NUM_TICKS		12
...
void CEQDlg::OnVScroll(UINT nSBCode, UINT nPos, CScrollBar* pScrollBar) 
{
	...
	case IDC_EQ0:
		equalizer[0] = (float)pow(10,(double)(0-m_eq0.GetPos()/LIMIT_DB_RATIO)/20);
		break;
	case IDC_EQ1:
		equalizer[1] = (float)pow(10,(double)(0-m_eq1.GetPos()/LIMIT_DB_RATIO)/20);
		break;
	case IDC_EQ2:
		equalizer[2] = (float)pow(10,(double)(0-m_eq2.GetPos()/LIMIT_DB_RATIO)/20);
		break;
	case IDC_EQ3:
		equalizer[3] = (float)pow(10,(double)(0-m_eq3.GetPos()/LIMIT_DB_RATIO)/20);
		break;
	case IDC_EQ4:
		equalizer[4] = (float)pow(10,(double)(0-m_eq4.GetPos()/LIMIT_DB_RATIO)/20);
		break;
	case IDC_EQ5:
		equalizer[5] = (float)pow(10,(double)(0-m_eq5.GetPos()/LIMIT_DB_RATIO)/20);
		break;
	case IDC_EQ6:
		equalizer[6] = (float)pow(10,(double)(0-m_eq6.GetPos()/LIMIT_DB_RATIO)/20);
		equalizer[7] = equalizer[6];
		break;
	case IDC_EQ7:
		equalizer[8] = (float)pow(10,(double)(0-m_eq7.GetPos()/LIMIT_DB_RATIO)/20);
		equalizer[9] = equalizer[8];
		equalizer[10] = equalizer[8];
		equalizer[11] = equalizer[8];
		break;
	case IDC_EQ8:
		equalizer[12] = (float)pow(10,(double)(0-m_eq8.GetPos()/LIMIT_DB_RATIO)/20);
		...
		break;
	case IDC_EQ9:
		equalizer[20] = (float)pow(10,(double)(0-m_eq9.GetPos()/LIMIT_DB_RATIO)/20);
