...
!MESSAGE "toolbar - Win32 NASM Debug MS STL" (based on "Win32 (x86) Dynamic-Link Library")
!MESSAGE 
...
# ADD LINK32 fabaselib.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /base:"0x11600000" /subsystem:windows /dll /machine:I386 /out:"toolbar.ui" /libpath:"..\..\..\..\base\win32"
...
# ADD LINK32 fabaselib.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /base:"0x11600000" /subsystem:windows /dll /debug /machine:I386 /out:"toolbar.ui" /pdbtype:sept /libpath:"..\..\..\..\base\win32"
# Begin Special Build Tool
SOURCE="$(InputPath)"
PostBuild_Cmds=IF NOT EXIST ..\..\..\..\base\win32\prj\plugins mkdir                                                        ..\..\..\..\base\win32\prj\plugins	copy toolbar.ui                                          ..\..\..\..\base\win32\prj\plugins
# End Special Build Tool
...
!ELSEIF  "$(CFG)" == "toolbar - Win32 NASM Debug MS STL"
...
# PROP Ignore_Export_Lib 0
# PROP Target_Dir ""
# ADD BASE CPP /nologo /MDd /W3 /Gm /GX /ZI /Od /I "..\include" /I "..\..\include" /I "..\..\..\include" /I "..\..\..\..\io\include" /I "..\..\..\..\base\include" /I "..\..\..\..\base\win32\include" /I "..\..\..\..\config" /I "..\..\..\..\ui\include" /I "..\..\..\..\lib\xml\include" /I "..\res" /D "_DEBUG" /D "_WINDOWS" /D "WIN32" /D "NOMINMAX" /YX /FD /c
# ADD CPP /nologo /MDd /W3 /Gm /GX /ZI /Od /I "..\include" /I "..\..\include" /I "..\..\..\include" /I "..\..\..\..\io\include" /I "..\..\..\..\base\include" /I "..\..\..\..\base\win32\include" /I "..\..\..\..\config" /I "..\..\..\..\ui\include" /I "..\..\..\..\lib\xml\include" /I "..\res" /D "_DEBUG" /D "_WINDOWS" /D "WIN32" /YX /FD /c
# ADD BASE MTL /nologo /D "_DEBUG" /mktyplib203 /o "NUL" /win32
# ADD MTL /nologo /D "_DEBUG" /mktyplib203 /o "NUL" /win32
# ADD BASE RSC /l 0x409 /d "_DEBUG"
# ADD RSC /l 0x409 /d "_DEBUG"
...
# ADD BSC32 /nologo
LINK32=link.exe
# ADD BASE LINK32 fabaselib.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /base:"0x11600000" /subsystem:windows /dll /debug /machine:I386 /out:"toolbar.ui" /pdbtype:sept /libpath:"..\..\..\..\base\win32"
# ADD LINK32 fabaselib.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /base:"0x11600000" /subsystem:windows /dll /debug /machine:I386 /out:"toolbar.ui" /pdbtype:sept /libpath:"..\..\..\..\base\win32"
# Begin Special Build Tool
SOURCE="$(InputPath)"
PostBuild_Cmds=IF NOT EXIST ..\..\..\..\base\win32\prj\plugins mkdir                                                        ..\..\..\..\base\win32\prj\plugins	copy toolbar.ui                                          ..\..\..\..\base\win32\prj\plugins
...
# Name "toolbar - Win32 NASM Debug MS STL"
# Begin Group "src"
